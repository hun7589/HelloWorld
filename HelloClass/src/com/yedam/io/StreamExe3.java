...
import com.yedam.collection.Student2;
...
public class StreamExe3 {
	...
	static List<Student2> studentList = new ArrayList<>(); // 컬렉션.
	...
	static void add() {
		...
		Student2 student = new Student2(Integer.parseInt(sno), Integer.parseInt(score));
	...
	static void init() throws IOException, NoSuchElementException {
		...
		while (true) {
			...
			studentList.add(//
					new Student2(Integer.parseInt(strAry[0])//
